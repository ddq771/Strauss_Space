# RS-25 — visual model for Strauss Space
...
- `../../Assets/Models/RS25/RS25_Engine.fbx`: Unity asset.
- `RS25_Engine.blend`: editable Blender source with preview studio.
- `RS25_Engine_preview.png`: render of the exported model's source geometry.
- `build_rs25.py`: model generator, using `../engine_asset.py`.
...
Refresh Unity, then drag `RS25_Engine.fbx` from its Project folder into a
...
```sh
blender --background --threads 8 --python ArtSource/RS25/build_rs25.py
```
